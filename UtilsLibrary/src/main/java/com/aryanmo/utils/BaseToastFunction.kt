...
interface BaseToastFunction : Basic {
    fun toast(message: String, duration: Int): Toast {
        return com.aryanmo.utils.utils.toast(appContext!!, message, duration)
    }
    ...
    fun shortToast(message: String): Toast {
        return com.aryanmo.utils.utils.shortToast(appContext!!, message)
    }
    ...
    fun longToast(message: String): Toast {
        return com.aryanmo.utils.utils.longToast(appContext!!, message)
    }
