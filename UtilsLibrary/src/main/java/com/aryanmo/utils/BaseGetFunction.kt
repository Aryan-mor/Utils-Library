...
interface BaseGetFunction : Basic {
    ...
    fun gString(s: String): String {
        return com.aryanmo.utils.utils.getString(appContext!!, s)
    }

    fun gString(@StringRes stringIdRes: Int): String {
        return com.aryanmo.utils.utils.getString(appContext!!, stringIdRes)
    }

    fun gStrings(divider: String, @StringRes vararg stringIdRes: Int): String {
        return com.aryanmo.utils.utils.getStrings(appContext!!, divider, *stringIdRes)
    }


    fun getFormattedString(@StringRes stringIdRes: Int, vararg args: Any): String {
        return com.aryanmo.utils.utils.getFormattedString(appContext!!, stringIdRes, *args)
    }
    ...
    fun getSpanned(context: Context, s: String): Spanned {
        return com.aryanmo.utils.utils.getSpanned(context,s)
    }

    fun getSpanned(context: Context, @StringRes stringIdRes: Int): Spanned? {
        return com.aryanmo.utils.utils.getSpanned(context,stringIdRes)
    }

    fun getSpanneds(context: Context, divider: String, @StringRes vararg stringIdRes: Int): Spanned {
        return com.aryanmo.utils.utils.getSpanneds(context,divider,*stringIdRes)
    }

    fun getFormattedSpanned(context: Context, @StringRes stringIdRes: Int, vararg args: Any): Spanned {
        return com.aryanmo.utils.utils.getFormattedSpanned(context,stringIdRes,args)
    }
    ...
    fun gDimen(@DimenRes dimenIdRes: Int): Float {
        return com.aryanmo.utils.utils.getDimen(appContext!!, dimenIdRes)
    }

    //DRAWABLE
    fun gDrawable(@DrawableRes drawableResId: Int): Drawable? {
        return com.aryanmo.utils.utils.getDrawable(appContext!!, drawableResId)
    }

    //COLOR
    fun gColor(@ColorRes colorIdRes: Int): Int {
        return com.aryanmo.utils.utils.getColor(appContext!!, colorIdRes)
    }

    fun gColor(s: String): Int {
        return com.aryanmo.utils.utils.getColor(s)

    }

    fun gColorHex(@ColorRes colorRes: Int): Int {
        return com.aryanmo.utils.utils.getColor(appContext!!, colorRes)
    }

    fun gColorString(@ColorRes colorRes: Int): String {
        return com.aryanmo.utils.utils.getColorString(appContext!!, colorRes)
    ...
    fun gMimeType(uri: String): String? {
        ...
        return com.aryanmo.utils.utils.getMimeType(uri)
    }

    fun gFileType(uri: String): String? {
        //TODO:Remove Function and create single file
        return com.aryanmo.utils.utils.getFileType(uri)
    }
