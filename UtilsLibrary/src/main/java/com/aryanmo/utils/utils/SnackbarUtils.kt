...
fun snackbar(activity: Activity, text: String, duration: Int, actionText: String?, runnable: Runnable?): Snackbar =
    snackbar(getView(activity), text, duration, actionText, runnable)

fun snackbar(v: View, text: String, duration: Int, @StringRes actionText: Int, runnable: Runnable?): Snackbar =
    snackbar(v, text, duration, getString(v.context, actionText), runnable)

fun snackbar(
    activity: Activity,
    text: String,
    duration: Int, @StringRes actionText: Int,
    runnable: Runnable?
): Snackbar = snackbar(getView(activity), text, duration, actionText, runnable)

fun snackbar(v: View, @StringRes text: Int, duration: Int, actionText: String?, runnable: Runnable?): Snackbar =
    snackbar(v, getString(v.context, text), duration, actionText, runnable)

fun snackbar(
    activity: Activity, @StringRes text: Int,
    duration: Int,
    actionText: String?,
    runnable: Runnable?
): Snackbar = snackbar(getView(activity), text, duration, actionText, runnable)

fun snackbar(v: View, @StringRes text: Int, duration: Int, @StringRes actionText: Int, runnable: Runnable?): Snackbar =
    snackbar(v, getString(v.context, text), duration, actionText, runnable)
...
fun snackbar(activity: Activity, @StringRes text: Int, duration: Int): Snackbar =
    snackbar(getView(activity), text, duration)
...
fun indefiniteSnackbar(v: View, @StringRes text: Int): Snackbar =
    snackbar(v, text, Snackbar.LENGTH_INDEFINITE, null, null)
