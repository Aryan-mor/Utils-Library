...
interface BaseLogFunction : Basic, BaseLogDFunction, BaseLogEFunction, BaseLogIFunction, BaseLogVFunction,
    ...
    fun log(s: Any, logFlag: String = FLAG, logType: Int = DEFAULT_BUFFER_SIZE) =
        ir.aryanmo.utils.utils.log.log(appContext, s, logFlag, logType)

    fun logKeyValue(key: Any, value: Any, logFlag: String = FLAG, logType: Int = DEFAULT_BUFFER_SIZE) =
        ir.aryanmo.utils.utils.log.log(key, value, logFlag, logType)

    fun log(map: Map<Any, Any>?, logFlag: String = FLAG, logType: Int = DEFAULT_BUFFER_SIZE) =
        ir.aryanmo.utils.utils.log.log(map, logFlag, logType)

    fun log(map: HashMap<Any, Any>?, logFlag: String = FLAG, logType: Int = DEFAULT_BUFFER_SIZE) =
        ir.aryanmo.utils.utils.log.log(map, logFlag, logType)

    fun log(strings: List<Any>, logFlag: String = FLAG, logType: Int = DEFAULT_BUFFER_SIZE) =
        ir.aryanmo.utils.utils.log.log(strings, logFlag, logType)

    fun logGson(json: String, logFlag: String = FLAG, logType: Int = DEFAULT_BUFFER_SIZE) =
